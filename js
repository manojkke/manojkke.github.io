...
function calculatePercentage() {
    ...
    var chart_1_canvas_6 = findAllColorsInCanvas(chart_1[6], 300, 1.0); // single
    greenVal = greenVal + chart_1_canvas_6[0];
    redVal = redVal + chart_1_canvas_6[1];
    var chart_1_canvas_10 = findAllColorsInCanvas(chart_1[10], 600, 1.0);// single
    ...
    var chart_2_canvas_4 = findAllColorsInCanvas(chart_2[4], 350, 1.0); // single
    greenVal = greenVal + chart_2_canvas_4[0];
    redVal = redVal + chart_2_canvas_4[1];
    var chart_2_canvas_8 = findAllColorsInCanvas(chart_2[8], 600, 1.0); // single
    greenVal = greenVal + chart_2_canvas_8[0];
    redVal = redVal + chart_2_canvas_8[1];
    var chart_2_canvas_12 = findAllColorsInCanvas(chart_2[12], 600, 1.0); // single
    ...
    var chart_3_canvas_4 = findAllColorsInCanvas(chart_3[4], 350, 1.5); // single
    greenVal = greenVal + chart_3_canvas_4[0];
    redVal = redVal + chart_3_canvas_4[1];
    var chart_3_canvas_8 = findAllColorsInCanvas(chart_3[8], 600, 1.5); // single
    greenVal = greenVal + chart_3_canvas_8[0];
    redVal = redVal + chart_3_canvas_8[1];
    var chart_3_canvas_12 = findAllColorsInCanvas(chart_3[12], 600, 1.5); // single
    ...
    var chart_4_canvas_4 = findAllColorsInCanvas(chart_4[4], 350, 1.0); // single 
    greenVal = greenVal + chart_4_canvas_4[0];
    redVal = redVal + chart_4_canvas_4[1];
    var chart_4_canvas_8 = findAllColorsInCanvas(chart_4[8], 600, 1.0); // single
    ...
    var chart_5_canvas_4 = findAllColorsInCanvas(chart_5[4], 350, 1.0); // single 
    greenVal = greenVal + chart_5_canvas_4[0];
    redVal = redVal + chart_5_canvas_4[1];
    var chart_5_canvas_8 = findAllColorsInCanvas(chart_5[8], 600, 1.0); // single
    greenVal = greenVal + chart_5_canvas_8[0];
    redVal = redVal + chart_5_canvas_8[1];
    var chart_5_canvas_12 = findAllColorsInCanvas(chart_5[12], 600, 1.0); // single
    ...
    $('.chart-toolbar').html('<button style="height: 100%;width: ' + redVal + 'px;background: red;"> ..</button><button style="height: 100%;width: ' + greenVal + 'px;background: green;"> ..</button>')

    if (redVal <= 30 || greenVal <= 30) {
        var audio = new Audio('https://www.myinstants.com/media/sounds/stupid-f__king-bird.mp3');
        audio.play();
    }
